...
if (!check.includes("farmSelect.value = wf.farmId") || !check.includes("parcelSelect.value = wf.parcelId")) throw new Error('Vlerat e ruajtura të Fermës/Parcelës nuk u injektuan.');
