...
(function (global) {
  ...
  async function createDemoScenario() {
    ...
    if (typeof S.saveSalesInvoice === 'function' && typeof S.registerSale === 'function') { await S.saveSalesInvoice(invoice); await S.registerSale(DEMO.saleId); } else throw new Error('Shërbimi i shitjes nuk është i disponueshëm në këtë version.');
